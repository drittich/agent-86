...
- You have a very large context window. Read whole files in one `read_file` call rather than paging through line ranges — don't fragment reads to save tokens.
